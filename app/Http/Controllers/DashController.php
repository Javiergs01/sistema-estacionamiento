...
class DashController extends Controller
{
  ...
  public function data()
  {
    ...
    $fromDateWithTime = Carbon::parse($start)->startOfDay();
    $toDateWithTime = Carbon::parse($finish)->endOfDay();
  ...
  LEFT JOIN(
  SELECT SUM(total)AS total, DATE(created_At)AS fecha FROM rentas WHERE created_at BETWEEN '$fromDateWithTime' AND '$toDateWithTime' AND estatus ='CERRADO'
