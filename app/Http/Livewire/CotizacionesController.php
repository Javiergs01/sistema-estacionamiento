...
class CotizacionesController extends Component
{
	...
	public function RegisterPay($coti_id, $monto)
	{
		...
		try {
			...
			$this->emit('msg-error', "Error al imprimir el recibo de pago, revisa el log del sistema");
	...
	public function Store()
	{
		...
		try {
			...
			$this->emit('msg-error', "Error al imprimir el recibo, revisa el log del sistema");
			Log::info($th->getMessage());
		}
	}
