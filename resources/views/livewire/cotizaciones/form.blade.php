		...
		<form>
			<div class="row">
				...
				<div class="form-group col-lg-12 col-md-12 col-sm-12">
					...
					<textarea wire:model.lazy="descripcion" cols="10" rows="4" class="form-control text-left"
						placeholder="viaje a manzanillo...."></textarea>
				...
				<div class="form-group col-lg-2 col-md-2 col-sm-12">
					...
					<input wire:model.lazy="salida" type="date" class="form-control ">
					@error('salida') <span class="text-danger">{{ $message }}</span> @enderror
				</div>
				<div class="form-group col-lg-2 col-md-2 col-sm-12">
					<label><b>Fecha de regreso</b></label>
					<input wire:model.lazy="regreso" type="date" class="form-control ">
			...
			<div class="row ">
				<div class="col-lg-5 mt-2  text-left">
					...
					@if($selected_id >0)
					<button type="button" wire:click="Update() " class="btn btn-primary ml-2">
						<i class="mbri-success"></i> Actualizar
					</button>
					@else
					<button type="button" wire:click="Store() " class="btn btn-primary ml-2">
