        ...
        <table cellpadding="0" cellspacing="0" class="" width="100%">
            ...
            <tr>
                ...
                <td width="92%" class="text-center text-company" style="vertical-align: top;  font-size: 15px">
                    ...
                    <br/>
                    <span class="text-right">Consulta del {{ \Carbon\Carbon::parse($fi)->format('d/m/Y g:i:s A') }} al {{ \Carbon\Carbon::parse($ff)->format('d/m/Y g:i:s A') }}</span>
                </td>
            </tr>
        </table>
...
<!-- sección cuerpo/tabla de contenidos  -->
    <section>
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" class="text-center">
                     ...
                     <td class="text-center">{{\Carbon\Carbon::parse($r->created_at)->format('d/m/Y h:m') }}</td>
                </tr>
                @endforeach
            ...
            <tfoot>
                <tr>
                    <td colspan="8" class="text-right" style="vertical-align: top; padding-right: 4px;">
